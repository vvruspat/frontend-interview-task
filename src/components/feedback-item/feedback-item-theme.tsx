...
export const FeedbackItemTheme = ({ id, sentiment, theme }: FeedbackItemThemeProps) => {
  ...
  return <ThemeButton data-testid={"feedback-item-theme"} data-themeid={id}>{theme}</ThemeButton>;
};
