...
import { FeedbackItemDate } from "./date/feedback-item-date";
import { FeedbackItemTheme } from "./themes/theme/feedback-item-theme";
import { FeedbackItemStyled } from "./feedback-item.styled";
import { FeedbackItemThemesStyled } from "./themes/feedback-item-themes.styled";
import { FeedbackItemCommentStyled } from "./comment/feedback-item-comment.styled";
...
export const FeedbackItem = ({
  ...
  return (
    <FeedbackItemStyled data-testid={"feedback-item"}>
